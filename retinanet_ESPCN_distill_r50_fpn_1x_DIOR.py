...
train_pipeline = [
    dict(type='LoadtwoImageFromFile'),
    dict(type='LoadAnnotations', with_bbox=True),
    dict(type='ResizeImagesToTwoScale', img_scale=[(416, 416)], img_scale2=[(832, 832)], keep_ratio=True),
    # dict(type='RandomFlip', flip_ratio=0.5),
    dict(type='Normalize', **img_norm_cfg),
    dict(type='PadTwoImage', pad_to_square=True),
